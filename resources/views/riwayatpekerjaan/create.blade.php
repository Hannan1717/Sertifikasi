...
@section('content')
    <div class="container">
        ...
        <form action="/riwayatpekerjaan/store" method="POST"> 
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nama_pekerjaan" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
            </div>

            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Jenis Pekerjaan</label>
                <input type="text" name="jenis_pekerjaan" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
            </div>
